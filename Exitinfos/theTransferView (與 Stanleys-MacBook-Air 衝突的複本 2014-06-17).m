...
@synthesize ShowBusDetailsDelegate,ShowYouBikeDataDelegate;
...
-(void)LoadingBusData
{
    ...
    if ([[[NSLocale preferredLanguages] objectAtIndex:0] isEqualToString:@"en"])
        ...
        BusData = [SQLite ReturnMultiRowsData:[NSString stringWithFormat:@"select * from MRTBusInfos where StationNumber = %i",StationNumber] andIndexOFColumn:CGPointMake(0, 7)];
