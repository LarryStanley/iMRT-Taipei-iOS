...
@synthesize ShowPlaceDetailsDelegate,PlaceReference,PlaceExit,ExitInfosSwiping,SelectedRowPosition,removePlaceDetailDelegate,PlaceResultTable;
...
- (id)initWithFrame:(CGRect)frame AndStationNumber:(int)StationNumber
{
    ...
    if (self) {
        ...
        if (![CheckInternet isConnectionAvailable]) {
            ...
            [CategoryTable setAutoresizesSubviews:YES];
            [CategoryTable setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
            ...
            [PlaceResultTable setAutoresizesSubviews:YES];
            [PlaceResultTable setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView == PlaceResultTable) {
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad){
            SelectedRowPosition = [PlaceResultTable convertRect:[PlaceResultTable rectForRowAtIndexPath:indexPath] toView:self.superview.superview];
            [removePlaceDetailDelegate RemovePlaceDetailViewDelegate:self];
        }
