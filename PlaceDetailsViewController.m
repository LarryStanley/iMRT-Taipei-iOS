...
- (void)viewDidLoad
{
    ...
    if ([CheckInternet isConnectionAvailable]) {
        ...
        [self.view addSubview:PowerByGoogleLogo];
        //設定結果元件
        if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7)
        ...
        ScrollView.contentSize = CGSizeMake(self.view.frame.size.width, 481);
        ...
        GoogleSearchButton = [[theGrayButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2-103, 395, 98, 33) AndButtonText:NSLocalizedString(@"Google", nil)];
        ...
        CallNumberButton = [[theGrayButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2-103, 438, 98, 33) AndButtonText:NSLocalizedString(@"Call", nil)];
        ...
        OfficeWebsiteButton = [[theGrayButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2+5, 438, 98, 33) AndButtonText:NSLocalizedString(@"Website", nil)];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    [tracker set:kGAIScreenName value:@"Place Detail View"];
...
-(void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error
{
    ...
    InternetFailLabel.center = CGPointMake(self.view.bounds.size.width/2, 70);
    InternetFailLabel.alpha = 0;
    [self.view addSubview:InternetFailLabel];
...
-(void)plotPositions:(NSDictionary *)data
{
    ...
    if (PlaceAddressLabel.frame.size.width > self.view.frame.size.width-40){
        PlaceAddressLabel.frame = CGRectMake(PlaceAddressLabel.frame.origin.x, PlaceAddressLabel.frame.origin.y, self.view.frame.size.width-40, PlaceAddressLabel.frame.size.height);
...
-(void)PlaceWebsiteButtonClick
{
    ...
    [tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"UX"
                                                          action:@"Pressed"
                                                           label:@"Place Office Website Button"
                                                           value:nil] build]];
    [tracker set:kGAIScreenName value:nil];
